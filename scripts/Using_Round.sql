...
-- Bu sorgumuzSda Satis detaylari tablomuzdan elde etti�imiz sat�lan "miktar,fiyat ve indirim" verilerimiz
    --ile "ALFKI" musteriID sine sahip musterinin toplam siparis tutarina ulastik.
